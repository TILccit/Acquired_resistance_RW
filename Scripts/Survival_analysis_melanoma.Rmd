---
title: "Survival analysis melanoma"
...
```{r Combined Univariable vs Multivariable Forest Plots - OS, fig.width=14, fig.height=7, warning=FALSE, message=FALSE, eval=TRUE}
...
```{r Combined Univariable vs Multivariable Forest Plots - PFS, fig.width=14, fig.height=7, warning=FALSE, message=FALSE, eval=TRUE}
# Prepare empty list to collect rows
rows <- vector("list", 0)
...
```{r Combined Univariable vs Multivariable Forest Plots - DSS, fig.width=14, fig.height=7, warning=FALSE, message=FALSE, eval=TRUE}
# Prepare empty list to collect rows
rows <- vector("list", 0)
